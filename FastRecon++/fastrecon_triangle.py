...
def get_args():
    ...
    parser.add_argument('--dataset_path', default='/Users/nasrin/Downloads/FastRecon-main/new_triangle_data')
    ...
    parser.add_argument('--coreset_sampling_ratio', default=0.03)  # 0.01
    parser.add_argument('--project_root_path',
                        default=r'./test/Triangle')  # 'D:\Project_Train_Results\mvtec_anomaly_detection\210624\test')
    parser.add_argument('--save_src_code', default=False)
    parser.add_argument('--save_anomaly_map', default=True)
    parser.add_argument('--n_neighbors', type=int, default=2)
    parser.add_argument('--k', type=int, default=4)
    parser.add_argument('--lambde', type=float, default=0.3)
