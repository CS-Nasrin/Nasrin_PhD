...
class STPM(pl.LightningModule):
    def __init__(self, hparams):
        ...
        self.data_transforms = transforms.Compose([
            transforms.Resize((args.load_size[0], args.load_size[1]), Image.Resampling.LANCZOS)
                                    ,
            transforms.ToTensor(),
...
def get_args():
    ...
    parser.add_argument('--dataset_path', default='./Data_analyze')
...
if __name__ == '__main__':
    ...
    #                                                                               # check_val_evsshery_n_epoch=args.val_freq,  num_sanity_val_steps=0) # ,fast_dev_run=True)
    trainer = pl.Trainer.from_argparse_args(args, accelerator='mps', devices=1, default_root_dir=os.path.join(args.project_root_path,args.category),
