...
def get_args():
    ...
    #                     default=r'./new_main')  # root directory for saving logs and results
    ...
    # parser.add_argument('--lambde', type=float, default=0.45) #Lambda regularization parameter for controlling model weight updates
    ...
    parser.add_argument('--load_size', default=[368, 368])  # 256/900
    parser.add_argument('--input_size', default=[368, 368])  # 224
    parser.add_argument('--coreset_sampling_ratio', default=0.025)  # 0.01
    parser.add_argument('--project_root_path',
                        default=r'./test/capsule')  # 'D:\Project_Train_Results\mvtec_anomaly_detection\210624\test')
    parser.add_argument('--save_src_code', default=False)
    parser.add_argument('--save_anomaly_map', default=True)
    parser.add_argument('--n_neighbors', type=int, default=2)
    parser.add_argument('--k', type=int, default=4)
    parser.add_argument('--lambde', type=float, default=0.5)
