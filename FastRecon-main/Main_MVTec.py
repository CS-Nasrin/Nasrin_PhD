...
def save_iou_results_to_excel(iou_results):
    ...
    excel_path = os.path.join(args.project_root_path, "iou_scores97.1400.xlsx")
...
class STPM(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        threshold = np.percentile(anomaly_map_resized_blur, 97)
        ...
        anomaly_binary = keep_large_components(anomaly_binary,1400)
        ...
        binary_mask_save_path = os.path.join(args.project_root_path, '22_0.97_1400')
...
def get_args():
    ...
    parser.add_argument('--batch_size', default=8) #Number of training samples used per batch
    ...
    parser.add_argument('--project_root_path',
                        default=r'./ResNet152/carpet')  # root directory for saving logs and results
