...
def save_iou_results_to_excel(iou_results):
    ...
    excel_path = os.path.join(args.project_root_path, "iou_scores95.1220.xlsx")
...
def compute_iou(gt_mask, anomaly_binary):
    ...
    # **Apply largest component filtering here**
    #anomaly_binary = keep_largest_component(anomaly_binary)
    #anomaly_binary = keep_large_components(anomaly_binary)  
...
class STPM(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        anomaly_binary = keep_large_components(anomaly_binary,1220)
        ...
        binary_mask_save_path = os.path.join(args.project_root_path, '22_0.95_1220')
...
def get_args():
    ...
    parser.add_argument('--coreset_sampling_ratio', default=0.05)  # 0.01
    parser.add_argument('--project_root_path',
                        default=r'./ResNet152/Triangle_avgpool')  # root directory for saving logs and results
